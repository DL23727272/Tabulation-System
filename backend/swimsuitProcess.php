    ...
    if (isset($_POST['data']) && isset($_POST['judgeId'])) {
        ...
        if (is_array($data)) {
            ...
            foreach ($data as $item) {
                ...
                $checkSql = "SELECT * FROM swimsuitandtrunks WHERE gender = '$gender' AND JudgeId = '$judgeId' AND candidate = '$candidate'";
                ...
                if ($result && $result->num_rows > 0) {
                    ...
                    $sql = "INSERT INTO swimsuitandtrunks (gender, candidate, score, rank, JudgeId) 
