...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['gender']) && isset($_POST['data']) && isset($_POST['judgeId'])) {
        ...
        $checkSql = "SELECT * FROM denimattire WHERE gender = '$gender' AND JudgeId = '$judgeId'";
        ...
        if ($result && $result->num_rows > 0) {
            ...
            if (is_array($data)) {
                ...
                foreach ($data as $item) {
                    ...
                    $sql = "INSERT INTO denimattire (gender, candidate, score, rank, JudgeId) VALUES ('$gender', '$candidate', '$score', '$rank', '$judgeId')"; // Include judgeId in the SQL query
